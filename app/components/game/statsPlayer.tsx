...
export default function StatsPlayer({
  ...
  return (
    <div className={`flex py-2 px-2 flex-col h-full w-full ${color === EColor.white ? 'text-black bg-white' : 'text-white bg-black'} border-4 ${game.turn === color ? 'border-yellow-700' : 'border-transparent'}`}>
